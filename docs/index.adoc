...
- autoconfigure project: `spring-boot-starter-hello-autoconfigure`
- start project: `spring-boot-starter-hello`
- testing project: `spring-boot-spring-boot-starter-hello-tests`
