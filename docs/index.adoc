...
- link:https://www.youtube.com/watch?v=N39hpGAT43s
- link:https://github.com/snicoll-demos/hello-service-auto-configuration
- link:https://github.com/snicoll/amqp-10-jms-spring-boot
